...
function HomepageModules() {
  const modules = [
    ...
    {
      title: 'Module 02: Digital Twin - Gazebo & Unity',
      description: 'Physics simulation, URDF modeling, and sensor integration',
      status: '✅ Available Now',
      statusType: 'complete',
      link: '/docs/modules/module-02-digital-twin-gazebo-unity/',
      chapters: 7,
      progress: 100,
    },
    {
      title: 'Module 03: AI-Robot Brain - Isaac/Nav2',
      description: 'Isaac Sim, Visual SLAM, perception pipeline, and autonomous navigation',
      status: '✅ Available Now',
      statusType: 'complete',
      link: '/docs/modules/module-03-ai-robot-brain-isaac/',
      chapters: 7,
      progress: 100,
    },
    {
      title: 'Module 04: Vision-Language-Action',
      description: 'Speech recognition, LLM task planning, and action execution',
      status: '✅ Available Now',
      statusType: 'complete',
      link: '/docs/modules/module-04-vla-vision-language-action/',
      chapters: 7,
      progress: 100,
    },
    {
